...
public interface IOracleService
{
    ...
    Task<Tuple<bool, OracleOrganization, string>> GetOrganizationById(string salesforceAccountId, SalesforceActionTransaction transaction, string? oraclePartyId = null);
    Task<Tuple<bool, OracleCustomerAccount, string>> GetCustomerAccountById(string salesforceAccountId, SalesforceActionTransaction transaction, string? oraclePartyId = null);
    ...
    // Address Endpoints
    Task<Tuple<bool, IEnumerable<OracleLocationModel>, string>> GetLocationsById(List<Tuple<string, string, string>> addressIds, SalesforceActionTransaction transaction);
    ...
    // Contact Endpoints
    Task<Tuple<bool, IEnumerable<OraclePersonObject>, string>> GetPersonsById(List<Tuple<string, string>> contactIds, SalesforceActionTransaction transaction);
...
public class OracleService : IOracleService
{
    ...
    #region Organization
    public async Task<Tuple<bool, OracleOrganization, string>> GetOrganizationById(string salesforceAccountId, SalesforceActionTransaction transaction, string? oraclePartyId = null)
    {
    ...
    public async Task<Tuple<bool, OracleCustomerAccount, string>> GetCustomerAccountById(string salesforceAccountId, SalesforceActionTransaction transaction, string? oraclePartyId = null)
    {
    ...
    public async Task<Tuple<bool, IEnumerable<OracleLocationModel>, string>> GetLocationsById(List<Tuple<string, string, string>> addressIds, SalesforceActionTransaction transaction)
    {
    ...
    public async Task<Tuple<bool, IEnumerable<OraclePersonObject>, string>> GetPersonsById(List<Tuple<string, string>> contactIds, SalesforceActionTransaction transaction)
    {
