...
{
    public class AssetSerialUpdateEventListener : IMessageListener
    {
        private readonly IConfiguration _config;
        private readonly ILogger<AssetEventListener> _logger;
        private readonly ICacheRepository _cacheRepo;

        public AssetSerialUpdateEventListener(IConfiguration config, ILogger<AssetEventListener> logger, ICacheRepository cacheRepo)
        {
            _config = config;
            _logger = logger;
        ...
        public void OnMessage(IClientSessionChannel channel, IMessage message)
        {
            ...
            var assetEvent = JsonConvert.DeserializeObject<MessageEnvelope<SalesforceAssetSerialUpdateEventPayload>>(convertedJson);
